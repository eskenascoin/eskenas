...
QList<KomodoUnits::Unit> KomodoUnits::availableUnits()
{
    ...
    unitlist.append(ESKN);
    unitlist.append(mESKN);
    unitlist.append(uESKN);
    return unitlist;
}
...
QString KomodoUnits::name(int unit)
{
    switch(unit)
    {
    case ESKN: return QString("ESKN");
    case mESKN: return QString("mESKN");
    case uESKN: return QString("uESKN");
...
QString KomodoUnits::description(int unit)
{
    switch(unit)
    {
    case ESKN: return QString("Coins");
    case mESKN: return QString("Milli-Coins (1 / 1" THIN_SP_UTF8 "000)");
    case uESKN: return QString("Micro-Coins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 KomodoUnits::factor(int unit)
{
    switch(unit)
    {
    case ESKN:  return 100000000;
    case mESKN: return 100000;
    case uESKN: return 100;
